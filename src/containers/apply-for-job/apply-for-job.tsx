              ...
              <div className="apply-job-form">
                ...
                <div className="personel-detail">
                  ...
                  <div>
                    ...
                    {errors.lastName && <span style={{fontSize:'10px', paddingLeft:'15px', color:'red'}}>*First Name is required</span>}
                  </div>
                  <div className="email-apply-job">
                    <div><label>Email*</label></div>
                    <input placeholder="Email" {...register("email", { required: true })}></input>
                    {errors.email && <span style={{fontSize:'10px', paddingLeft:'15px', color:'red'}}>*First Name is required</span>}
                  </div>
                  <div>
                    <div><label>Contact Number*</label></div>
                    <input placeholder="Contact Number" {...register("mobile", { required: true })}></input>
                    {errors.mobile && <span style={{fontSize:'10px', paddingLeft:'15px', color:'red'}}>*First Name is required</span>}
                  </div>
                </div>
                <div className="select-tech">
                  ...
                  {errors.technology && <span style={{fontSize:'10px', paddingLeft:'15px', color:'red'}}>*First Name is required</span>}
                </div>
                ...
                <input type="submit" className="create-account-btn"/>
              </div>
            </form>
          </Col>
        </div>
